...
1. 前往 [Releases](https://github.com/793383996/RustSearch-AS/releases) 下载最新 `RustSearch-AS-x.x.x.zip`
...
native 库放在 `src/main/resources/native/<platform>/` 下,由 `RustSearchService` 在启动时按平台加载。
